...
String username;
            int N1;
    public recepit1(String username,String p1,String p2,String p3,String p4,int p5,String p6){
    initComponents();
    ...
    private void initComponents() {
		...
		btnNewButton.setBounds(600,480, 112, 38);
		jPanel1.add(btnNewButton);
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				jPanel1.setVisible(false);   new login().setVisible(true);
			}
		});
		
		 JButton btnNewButton1 = new JButton("history");
			btnNewButton1.setFont(new Font("Tahoma", Font.PLAIN, 18));
			btnNewButton1.setBounds(750,480, 112, 38);
			jPanel1.add(btnNewButton1);
			btnNewButton1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					jPanel1.setVisible(false);   history frame = new history(username);
