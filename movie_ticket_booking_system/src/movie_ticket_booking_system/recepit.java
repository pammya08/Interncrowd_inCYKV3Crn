...
public class recepit extends javax.swing.JFrame {
    ...
    String username; String a;String b;String c;String e;String f;
            int N1;
    public recepit(String p,String p1,String p2,String p3,String p4,int p5,String p6){
    initComponents();
    username=p;
    this.a=p1;
    this.b=p2;
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	 try {
					...
					Connection	c=DriverManager.getConnection("jdbc:mysql://localhost:3306/movie_ticket_system","root","Pravin08@");
	     			...
	     			String str = "INSERT INTO history values ('"+username+"', '"+e+"', '"+b+"', '"+a+"', '"+f+"','"+N1+"')";
...
this.setVisible(false);         new cardselection(username,a,b,c,e,N1,f).setVisible(true);
