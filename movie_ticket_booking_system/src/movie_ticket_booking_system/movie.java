...
public class movie extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		btnNewButton1.setBounds(400,485, 112, 38);
     ...
     public void workWithDatabase()
    {
      ...
      if(N2<10 && N2>0)
         ...
         {  
             ...
             new recepit(username,a,b,e,d,N1,f).setVisible(true); 
       
         try
   {
        	 Class.forName("com.mysql.cj.jdbc.Driver");
     		c=DriverManager.getConnection("jdbc:mysql://localhost:3306/movie_ticket_system","root","Pravin08@");
